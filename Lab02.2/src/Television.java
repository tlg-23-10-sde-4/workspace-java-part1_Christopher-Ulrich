...
class Television {
    ...
    public void setBrand(String brand) {  // Doing 2 jobs: validating and assigning ONLY IF VALID
        boolean valid = false;
    ...
    /* public void setVolume(int volume) {
        if (volume > MAX_VOLUME || volume < MIN_VOLUME) {
            ...
            System.out.println("Your volume of " + volume + " is outside the range of " + MIN_VOLUME +
                    " - " + MAX_VOLUME + ". Volume reset to " + this.volume);
        } else {
            this.volume = volume;
        }
    } */
    ...
    public void setVolume(int volume) {
        if (MIN_VOLUME <= volume && volume <= MAX_VOLUME) {
            ...
            System.out.println("Volume is outside of range.");
        }
    }
    ...
    public boolean isMuted() {
        ...
        //public void getVerifyInternetConnection() {
        //    this.verifyInternetConnection() = verifyInternetConnection;
        //}
