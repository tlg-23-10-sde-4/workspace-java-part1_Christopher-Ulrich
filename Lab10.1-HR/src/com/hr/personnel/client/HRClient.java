...
class HRClient {
    ...
    public static void main(String[] args) {    // Placing a 'throws IllegalWageException' here is optional and not best practice; best to handle with trycatch
        ...
        try {   // Wouldn't do 2 at a time in the same try block
